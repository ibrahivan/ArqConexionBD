...
public class ADto {
	...
	/*public ArrayList<LibroDto> resultsALibrosDto(ResultSet resultadoConsulta){
		...
		try {
			...
			System.out.println("[INFORMACIÓN-ADto-resultsALibrosDto] Número de ...: "+i);
			
		} catch (SQLException e) {
			System.out.println("[ERROR-ADto-resultsALibrosDto] Error al pasar el result set a lista de Entidad" + e);
		}
